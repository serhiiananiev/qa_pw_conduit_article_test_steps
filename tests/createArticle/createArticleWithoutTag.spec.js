...
test('Create an article with required fields', async () => {
    ...
    await createArticlePage.fillDescriptionField('Test Description');
    await createArticlePage.fillBodyField('Test Body');
    await createArticlePage.clickPublishArticleButton();
    await createArticlePage.waitForCreatedArticlePage();
    await createArticlePage.checkCreatedArticleTitleIsHere('Test Title');
